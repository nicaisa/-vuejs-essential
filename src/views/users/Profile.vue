			...
			<div class="panel-body">
				...
				<div class="form-horizontal" data-validator-form>
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input v-model.trim="username" v-validator:input.required="{ title: '用户名', regex: /^[a-zA-Z]+\w*\s?\w*$/, error: '用户名要求以字母开头的单词字符' }" type="text" value=""  class="form-control"/>
						</div>
					</div>
					<div class="form-group">
